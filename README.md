...
Groq provides Llama 3.3 70B with 128K context for free. The 128K window means all 6 retrieved chunks fit comfortably with room to spare, unlike GPT-3.5's 4K limit.
...
| LLM | Groq Llama 3.3 70B | Free tier, 128K context, fast inference |
